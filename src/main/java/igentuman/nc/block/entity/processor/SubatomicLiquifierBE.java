...
public class SubatomicLiquifierBE extends NCProcessorBE {

    public SubatomicLiquifierBE(BlockPos pPos, BlockState pBlockState) {
        super(pPos, pBlockState, Processors.SUBATOMIC_LIQUIFIER);
    ...
    public static class Recipe extends NcRecipe {
        ...
        public String getCodeId() {
            return Processors.SUBATOMIC_LIQUIFIER;
        }
    }
}
