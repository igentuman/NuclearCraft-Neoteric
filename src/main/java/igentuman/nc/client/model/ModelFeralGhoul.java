...
public class ModelFeralGhoul extends HumanoidModel<EntityFeralGhoul> {
    ...
    public void setupAnim(EntityFeralGhoul entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        // Reset positions to match the old model
        ...
        // Add the arm swinging animation from the old model
    ...
    @Override
    public void prepareMobModel(EntityFeralGhoul entity, float limbSwing, float limbSwingAmount, float partialTick) {
