...
public class FissionEmiCategory extends BasicEmiRecipe {
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(
            rl("fission_reactor_controller"),
            EmiStack.of(CATALYSTS.containsKey("fission_reactor_controller") ? 
                new ItemStack(FISSION_BLOCKS.get("fission_reactor_controller").get()) : 
                new ItemStack(BARRIER))
    );

    private final FissionControllerBE.Recipe recipe;

    public FissionEmiCategory(FissionControllerBE.Recipe recipe) {
