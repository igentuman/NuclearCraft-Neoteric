...
/**
 * JEI recipe wrapper for accelerator cooler placement conditions
 * Based on the HeatSinkPlacementRecipe but adapted for accelerator coolers
 */
public class CoolerPlacementRecipe {
    ...
    public CoolerPlacementRecipe(ResourceLocation id, CoolerDef coolerDef, ItemStack coolerItem) {
        this.id = id;
