...
public class LinearAcceleratorDevice {
    ...
    public static RPCDevice createDevice(LinearAcceleratorControllerBE blockEntity) {
        return new ObjectDevice(new LinearAcceleratorDeviceRecord(blockEntity));
    }

    public record LinearAcceleratorDeviceRecord(LinearAcceleratorControllerBE terminal) implements NamedDevice {
        ...
        @Callback
        public final int getBeamLength() {
            return terminal.beamLength;
        }
