...
public class DecayChamberPonderScenes {
    ...
    public static void create(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(60)
                ...
                .text("Decay Chamber size can be from 5x5x5 up to 11x11x11.");
        ...
        scene.overlay().showText(55)
                ...
                .text("The center of the structure must be a Particle Chamber Camera.");
        ...
        scene.overlay().showText(40)
                ...
                .text("One beam port feeds the input beam; the others carry off the lighter particles split out of it.");
        ...
        scene.overlay().showText(55)
                ...
                .text("Add Particle Chamber Ports for energy and item/fluid transport.");
        scene.idle(10);
        ...
        scene.idle(55);
        scene.addKeyframe();
        scene.world().setBlock(util.grid().at(2, 3, 4), PARTICLE_CHAMBER_BLOCKS.get("decay_chamber_controller").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.SOUTH), true);
        scene.overlay().showText(40)
                .pointAt(util.vector().blockSurface(util.grid().at(2, 3, 4), Direction.NORTH))
                .text("Place the Decay Chamber Controller on the casing.");

        scene.idle(45);
        scene.world().restoreBlocks(util.select().fromTo(0,0,0,4,4,4));
        scene.world().setBlock(util.grid().at(2, 3, 4), PARTICLE_CHAMBER_BLOCKS.get("decay_chamber_controller").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.SOUTH).setValue(POWERED, true), false);
