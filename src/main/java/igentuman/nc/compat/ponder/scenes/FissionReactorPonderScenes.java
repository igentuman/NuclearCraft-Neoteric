...
import static igentuman.nc.block.UniversalProcessorBlock.POWERED;
...
public class FissionReactorPonderScenes {
    ...
    public static void create(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world().setBlock(util.grid().at(2, 4, 0), ModEntries.get("fission_reactor_casing").block().get().defaultBlockState(), false);
        scene.world().setBlock(util.grid().at(0, 1, 1), ModEntries.get("fission_reactor_glass").block().get().defaultBlockState(), false);
        scene.world().setBlock(util.grid().at(4, 1, 1), ModEntries.get("fission_reactor_glass").block().get().defaultBlockState(), false);
        ...
        scene.idle(55);
        scene.addKeyframe();
        scene.world().setBlock(util.grid().at(0, 1, 1), ModEntries.get("fission_reactor_port").block().get().defaultBlockState(), true);
        ...
        scene.idle(50);
        scene.world().setBlock(util.grid().at(4, 1, 1), ModEntries.get("fission_reactor_port").block().get().defaultBlockState(), true);
        scene.overlay().showText(55)
        ...
        scene.world().showSection(util.select().fromTo(1,1, 0, 3, 5, 0), Direction.SOUTH);
        scene.idle(15);
        scene.world().setBlock(util.grid().at(2, 4, 0), ModEntries.get("irradiator").block().get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH), true);
        ...
        scene.world().setBlock(util.grid().at(2, 4, 0), ModEntries.get("irradiator").block().get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH).setValue(POWERED, true), false);
        scene.world().setBlock(util.grid().at(2, 1, 0), ModEntries.get("fission_reactor_controller").block().get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH), false);

        scene.idle(55);
        scene.addKeyframe();
        scene.world().setBlock(util.grid().at(2, 3, 2), ModEntries.get("fission_reactor_pile-driver_irradiation_chamber").block().get().defaultBlockState(), false);
