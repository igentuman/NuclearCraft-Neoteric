...
import static igentuman.nc.block.heat_exchanger.HeatExchangerPortBlock.HORIZONTAL_FACING;
...
public class HeatExchangerPonderScenes {
    ...
    public static void create(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        BlockState casing = HX_BLOCKS.get("heat_exchanger_casing").get().defaultBlockState();
        ...
        scene.addKeyframe();
        scene.world().setBlock(util.grid().at(2, 2, 0), HX_BLOCKS.get("heat_exchanger_controller").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH), true);
        ...
        scene.addKeyframe();
        scene.world().setBlock(util.grid().at(1, 1, 0), HX_BLOCKS.get("heat_exchanger_hot_coolant_port").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH), true);
        scene.world().setBlock(util.grid().at(3, 1, 0), HX_BLOCKS.get("heat_exchanger_hot_coolant_port").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH), true);
        ...
        scene.addKeyframe();
        scene.world().setBlock(util.grid().at(1, 3, 0), HX_BLOCKS.get("heat_exchanger_cold_coolant_port").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH), true);
        scene.world().setBlock(util.grid().at(3, 3, 0), HX_BLOCKS.get("heat_exchanger_cold_coolant_port").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH), true);
        ...
        scene.addKeyframe();
        scene.world().setBlock(util.grid().at(1, 4, 2), HX_BLOCKS.get("heat_exchanger_radiator").get().defaultBlockState(), true);
        scene.world().setBlock(util.grid().at(2, 4, 2), HX_BLOCKS.get("heat_exchanger_radiator").get().defaultBlockState(), true);
        scene.world().setBlock(util.grid().at(3, 4, 2), HX_BLOCKS.get("heat_exchanger_radiator").get().defaultBlockState(), true);
        scene.world().setBlock(util.grid().at(1, 4, 3), HX_BLOCKS.get("heat_exchanger_radiator").get().defaultBlockState(), true);
        scene.world().setBlock(util.grid().at(2, 4, 3), HX_BLOCKS.get("heat_exchanger_radiator").get().defaultBlockState(), true);
        scene.world().setBlock(util.grid().at(3, 4, 3), HX_BLOCKS.get("heat_exchanger_radiator").get().defaultBlockState(), true);
        ...
        scene.idle(15);
        scene.world().setBlock(util.grid().at(2, 2, 0), HX_BLOCKS.get("heat_exchanger_controller").get().defaultBlockState().setValue(HORIZONTAL_FACING, Direction.NORTH).setValue(POWERED, true), false);
        scene.overlay().showText(70)
                .pointAt(util.vector().blockSurface(util.grid().at(2, 2, 0), Direction.NORTH))
