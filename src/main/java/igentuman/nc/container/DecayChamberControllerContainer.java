...
public class DecayChamberControllerContainer extends AbstractContainerMenu {

    protected final DecayChamberControllerBE blockEntity;
    protected final Player playerEntity;
    protected final String name = "decay_chamber_controller";
    private int slotIndex = 0;
    protected final IItemHandler playerInventory;

    public DecayChamberControllerContainer(int pContainerId, BlockPos pos, Inventory playerInventory) {
        super(DECAY_CHAMBER_CONTROLLER_CONTAINER.get(), pContainerId);
