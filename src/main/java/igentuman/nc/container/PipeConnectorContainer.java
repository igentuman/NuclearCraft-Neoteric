...
import static igentuman.nc.block.pipe.entity.PipeConnectorBE.CAP_COUNT;
import static igentuman.nc.setup.registration.NCBlocks.PIPE_CONNECTOR_BLOCK;
...
public class PipeConnectorContainer extends AbstractContainerMenu {
    ...
    // Button ids routed through PacketGuiButtonPress; must not collide with Button.*.BTN_ID.
    ...
    public @NotNull ItemStack quickMoveStack(@NotNull Player p, int index) {
        // No container slots to move into; shift-click swaps between player inventory and hotbar.
    ...
    public boolean stillValid(@NotNull Player p) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()),
                player, PIPE_CONNECTOR_BLOCK.get());
    }
