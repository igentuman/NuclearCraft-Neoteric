...
public class IsotopeSeparatorRecipes {
    ...
    public static void isotopeSeparator(RecipeOutput out) {
        sep(out, "lithium",    dust("lithium"),    10, isotope("lithium/7"),    9, isotope("lithium/6"),    1);
        sep(out, "yellowcake", dust("yellowcake"), 10, isotope("uranium/238"),  7, isotope("uranium/235"),  2);
        sep(out, "uranium",    dust("uranium"),    10, isotope("uranium/238"),  9, isotope("uranium/235"),  1);
        sep(out, "thorium",    dust("thorium"),    10, isotope("thorium/232"),  9, isotope("thorium/230"),  1);
