...
public class NCRecipes extends RecipeProvider {
    ...
    private void bombs(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(NC_DUSTS.get(Materials.barium_nitrate).get())
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("neutron_initiator").get())
                .pattern(" B ")
                .pattern("BPB")
                .pattern(" B ")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("compression_charge").get())
                .pattern("STB")
                .pattern("TB ")
                .pattern("STB")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("pu_239_pit").get())
                .pattern("FFF")
                .pattern("FNF")
                .pattern("FFF")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("pu_239_core").get())
                .pattern("FFF")
                .pattern("FNF")
                .pattern("FFF")
        ...
        ShapedRecipeBuilder.shaped(PU_239_BOMB_ITEM.get())
                .pattern("CCC")
                .pattern("CNC")
                .pattern("CCC")
    ...
    private void acceleratorItems(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(CHARGING_STATION_BLOCK.get(), 1)
                .pattern("SBS")
                .pattern("S S")
                .pattern("STS")
        ...
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("empty_cooler").get(), 8)
                .pattern("STS")
                .pattern("SHS")
                .pattern("STS")
        ...
        // Detector casing
        ShapedRecipeBuilder.shaped(NC_PARTS.get("empty_detector").get(), 4)
                .pattern("STS")
                .pattern("SBS")
                .pattern("STS")
                .define('S', forgeIngot(Materials.steel))
        ...
        // Wire chamber casing
        ShapedRecipeBuilder.shaped(NC_PARTS.get("wire_chamber_casing").get())
                .pattern("WWW")
                .pattern("ACA")
                .pattern("WWW")
        ...
        // Scintillator PWO
        ShapedRecipeBuilder.shaped(NC_PARTS.get("scintillator_pwo").get())
                .pattern("PPP")
                .pattern("PWP")
                .pattern("PPP")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("scintillator_plastic").get())
                .pattern("PPP")
                .pattern("PBP")
                .pattern("PPP")
        ...
        // Laser assembly
        ShapedRecipeBuilder.shaped(NC_PARTS.get("laser_assembly").get())
                .pattern("GRG")
                .pattern("RDR")
                .pattern("GRG")
                .define('G', GLASS)
        ...
        ShapedRecipeBuilder.shaped(ION_SOURCES.get("tungsten_filament").get())
                .pattern("TTT")
                .pattern("TWT")
                .pattern("TTT")
                .define('T', forgeIngot(Materials.tungsten))
        ...
        // Wire gold tungsten
        ShapedRecipeBuilder.shaped(NC_PARTS.get("wire_gold_tungsten").get(), 4)
                .pattern("GWG")
    ...
    private void targetChamberBlocks(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("target_chamber_controller").get())
                .pattern("PTP")
                .pattern("BFB")
                .pattern("PTP")
        ...
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("decay_chamber_controller").get())
                .pattern("PTP")
                .pattern("BFB")
                .pattern("PTP")
                .define('P', NC_PARTS.get("plate_elite").get())
        ...
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("collision_chamber_controller").get())
                .pattern("PTP")
                .pattern("BFB")
                .pattern("PTP")
                .define('P', NC_PARTS.get("plate_elite").get())
        ...
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("target_chamber_casing").get(), 4)
                .pattern("STS")
                .pattern("T T")
                .pattern("STS")
        ...
        ShapelessRecipeBuilder.shapeless(PARTICLE_CHAMBER_BLOCKS.get("target_chamber_casing_glass").get())
        ...
        ShapelessRecipeBuilder.shapeless(PARTICLE_CHAMBER_BLOCKS.get("target_chamber_casing").get())
        ...
        // Target chamber port
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("target_chamber_port").get(), 4)
                .pattern("THT")
                .pattern("VFV")
                .pattern("THT")
                .define('T', forgeIngot(Materials.tungsten))
        ...
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("target_chamber_beam_port").get(), 4)
                .pattern("STS")
                .pattern("BFB")
                .pattern("STS")
                .define('S', forgeIngot(Materials.steel))
        ...
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("target_chamber_camera").get())
                .pattern("NSN")
                .pattern("NCN")
                .pattern("NSN")
                .define('S', forgeIngot(Materials.steel))
        ...
        // Detectors
        // EM Calorimeter
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("em_calorimeter").get())
                .pattern("SSS")
                .pattern("SCS")
                .pattern("SSS")
        ...
        // Hadron Calorimeter
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("hadron_calorimeter").get())
                .pattern("SSS")
                .pattern("SCS")
                .pattern("SSS")
        ...
        // Silicon Tracker
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("silicon_tracker").get())
                .pattern("BAB")
                .pattern("ACA")
                .pattern("BAB")
                .define('B', NC_PARTS.get("basic_processor").get())
        ...
        // Wire Chamber
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("wire_chamber").get())
                .pattern("WWW")
                .pattern("WCW")
                .pattern("WWW")
                .define('W', NC_PARTS.get("wire_gold_tungsten").get())
        ...
        // Bubble Chamber
        ShapedRecipeBuilder.shaped(PARTICLE_CHAMBER_BLOCKS.get("bubble_chamber").get())
                .pattern("GGG")
                .pattern("GCG")
                .pattern("GGG")
                .define('G', GLASS)
    ...
    private void acceleratorBlocks(Consumer<FinishedRecipe> consumer) {
        ...
        for(String name: coolers().keySet()) {
            ...
            ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get(name+"_cooler").get())
                    .pattern(" I ")
                    .pattern("IBI")
                    .pattern(" I ")
        ...
        // Accelerator casing
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("accelerator_casing").get(), 4)
                .pattern("STS")
                .pattern("T T")
                .pattern("STS")
        ...
        ShapelessRecipeBuilder.shapeless(ACCELERATOR_BLOCKS.get("accelerator_casing_glass").get())
        ...
        ShapelessRecipeBuilder.shapeless(ACCELERATOR_BLOCKS.get("accelerator_casing").get())
        ...
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("beam_diverter_controller").get())
                .pattern("PEP")
                .pattern("BFB")
                .pattern("PEP")
                .define('P', NC_PARTS.get("plate_elite").get())
        ...
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("linear_accelerator_controller").get())
                .pattern("PEP")
                .pattern("BFB")
                .pattern("PEP")
                .define('P', NC_PARTS.get("plate_elite").get())
        ...
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("ring_accelerator_controller").get())
                .pattern("PEP")
                .pattern("AFA")
                .pattern("PEP")
                .define('P', NC_PARTS.get("plate_elite").get())
        ...
        // Accelerator port
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("accelerator_port").get(), 4)
                .pattern("SHS")
                .pattern("VFV")
                .pattern("SHS")
                .define('S', forgeIngot(Materials.steel))
        ...
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("accelerator_beam_port").get(), 4)
                .pattern("STS")
                .pattern("BFB")
                .pattern("STS")
                .define('S', forgeIngot(Materials.steel))
        ...
        // Particle beam
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("particle_beam").get(), 3)
                .pattern("SSS")
                .pattern("BBB")
                .pattern("SSS")
                .define('S', forgeIngot(Materials.steel))
        ...
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("accelerator_ion_source_port").get())
                .pattern("LPL")
                .pattern("EIE")
                .pattern("LPL")
        ...
        // Electromagnet yoke
        ShapedRecipeBuilder.shaped(ACCELERATOR_BLOCKS.get("electromagnet_yoke").get(), 4)
                .pattern("III")
                .pattern("IFI")
                .pattern("III")
    ...
    private void kugelBlitzBlocks(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(EXPL_BLOCK.get())
                .pattern(" P ")
                .pattern("CMC")
                .pattern("LBL")
        ...
        ShapedRecipeBuilder.shaped(KUGELBLITZ_BLOCKS.get("neutronium_frame").get())
                .pattern("ETE")
                .pattern("TPT")
                .pattern("ETE")
                .define('E', forgeIngot(Materials.extreme))
        ...
        ShapedRecipeBuilder.shaped(KUGELBLITZ_BLOCKS.get("event_horizon_stabilizer").get())
                .pattern("BQB")
                .pattern("ENE")
                .pattern("BQB")
        ...
        ShapedRecipeBuilder.shaped(KUGELBLITZ_BLOCKS.get("quantum_flux_regulator").get())
                .pattern("CEC")
                .pattern("ENE")
                .pattern("CEC")
        ...
        ShapedRecipeBuilder.shaped(KUGELBLITZ_BLOCKS.get("quantum_transformer").get())
                .pattern("DCD")
                .pattern("ENE")
                .pattern("DCD")
        ...
        ShapedRecipeBuilder.shaped(KUGELBLITZ_BLOCKS.get("photon_concentrator").get())
                .pattern("GQG")
                .pattern("ENE")
                .pattern("GQG")
                .define('G', GLASS)
        ...
        ShapedRecipeBuilder.shaped(KUGELBLITZ_BLOCKS.get("chamber_port").get())
                .pattern("SPS")
                .pattern("ENE")
                .pattern("SPS")
        ...
        ShapedRecipeBuilder.shaped(KUGELBLITZ_BLOCKS.get("chamber_terminal").get())
                .pattern("CPC")
                .pattern("ENE")
                .pattern("CPC")
                .define('C', NC_PARTS.get("basic_electric_circuit").get())
    ...
    private void fusionBlocks(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(MULTIBLOCK_BUILDER_BLOCK.get())
                .pattern("LDL")
                .pattern("PCP")
                .pattern("LML")
                .define('C', BEACON)
        ...
        ShapedRecipeBuilder.shaped(REDSTONE_DIMMER_BLOCK.get())
                .pattern("LPL")
                .pattern("CMC")
                .pattern("LPL")
                .define('C', COMPARATOR)
        ...
        ShapedRecipeBuilder.shaped(FUSION_BLOCKS.get("fusion_reactor_connector").get())
                .pattern("LPL")
                .pattern("PMP")
                .pattern("LPL")
        ...
        ShapedRecipeBuilder.shaped(FUSION_BLOCKS.get("fusion_reactor_casing").get())
                .pattern("LPL")
                .pattern("PMP")
                .pattern("LPL")
        ...
        ShapedRecipeBuilder.shaped(FUSION_BLOCKS.get("fusion_reactor_casing_glass").get())
                .pattern(" G ")
                .pattern("GMG")
                .pattern(" G ")
    ...
    private void storageBlocks(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(NCCrafter.ENGINEERS_CRAFTING_TABLE_BLOCK.get(), 1)
                .pattern("SCS")
                .pattern("PHP")
                .pattern("STS")
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("basic_storage_container").get())
                .pattern(" P ")
                .pattern("PCP")
                .pattern(" P ")
                .define('C', CHEST)
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("advanced_storage_container").get())
                .pattern("DPD")
                .pattern("PCP")
                .pattern("DPD")
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("du_storage_container").get())
                .pattern("DPD")
                .pattern("PCP")
                .pattern("DPD")
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("elite_storage_container").get())
                .pattern("DPD")
                .pattern("PCP")
                .pattern("DPD")
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("basic_barrel").get())
                .pattern("GPG")
                .pattern("G G")
                .pattern("GPG")
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("advanced_barrel").get())
                .pattern("GPG")
                .pattern("GBG")
                .pattern("GPG")
                .define('B', STORAGE_BLOCKS.get("basic_barrel").get())
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("du_barrel").get())
                .pattern("GPG")
                .pattern("GBG")
                .pattern("GPG")
        ...
        ShapedRecipeBuilder.shaped(STORAGE_BLOCKS.get("elite_barrel").get())
                .pattern("GPG")
                .pattern("GBG")
                .pattern("GPG")
    ...
    private void energyBlocks(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ENERGY_BLOCKS.get("decay_generator").get())
                .pattern("PGP")
                .pattern("GUG")
                .pattern("PGP")
                .define('G', REDSTONE)
    ...
    private void items(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(NCCrafter.CRAFTING_PATTERN.get())
                .requires(PAPER)
    ...
    private void parts(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(PIPE_BLOCK.get(), 8)
                .pattern("BSB")
                .pattern("S S")
                .pattern("BSB")
                .define('B', NC_PARTS.get("bioplastic").get())
        ...
        ShapedRecipeBuilder.shaped(PIPE_CONNECTOR_BLOCK.get(), 2)
                .pattern("BSB")
                .pattern("SAS")
                .pattern("BSB")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("plate_basic").get(), 2)
                .pattern("LG")
                .pattern("GL")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("plate_advanced").get(), 2)
                .pattern(" P ")
                .pattern("TRT")
                .pattern(" P ")
                .define('R', REDSTONE)
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("plate_du").get())
                .pattern("SUS")
                .pattern("UPU")
                .pattern("SUS")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("plate_elite").get())
                .pattern("RBR")
                .pattern("BPB")
                .pattern("RBR")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("plate_extreme").get())
                .pattern("RBR")
                .pattern("BPB")
                .pattern("RBR")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("coil_copper").get())
                .pattern("CC ")
                .pattern("II ")
                .pattern("CC ")
                .define('C', forgeIngot(Materials.copper))
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("coil_magnesium_diboride").get())
                .pattern("MM ")
                .pattern("TT ")
                .pattern("MM ")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("servo").get())
                .pattern("F F")
                .pattern("RSR")
                .pattern("SCS")
                .define('F', forgeIngot(Materials.ferroboron))
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("motor").get())
                .pattern("SSG")
                .pattern("CCI")
                .pattern("SSG")
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("actuator").get())
                .pattern("  S")
                .pattern("FP ")
                .pattern("CF ")
                .define('F', forgeIngot(Materials.ferroboron))
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("chassis").get())
                .pattern("LSL")
                .pattern("STS")
                .pattern("LSL")
                .define('S', forgeIngot(Materials.steel))
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("empty_frame").get())
                .pattern("PTP")
                .pattern("I I")
                .pattern("PTP")
                .define('I', forgeIngot(Materials.iron))
        ...
        ShapedRecipeBuilder.shaped(NC_PARTS.get("steel_frame").get())
                .pattern("STS")
                .pattern("TBT")
                .pattern("STS")
                .define('S', forgeIngot(Materials.steel))
    ...
    private void fissionBlocks(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("fission_reactor_irradiation_chamber").get())
                .pattern("LPL")
                .pattern("MTM")
                .pattern("LPL")
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("fission_reactor_port").get())
                .pattern("LPL")
                .pattern("MTM")
                .pattern("LPL")
                .define('M', NC_PARTS.get("servo").get())
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("fission_reactor_casing").get(), 4)
                .pattern("LPL")
                .pattern("P P")
                .pattern("LPL")
                .define('P', NC_PARTS.get("plate_advanced").get())
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("fission_reactor_controller").get())
                .pattern("LPL")
                .pattern("TDT")
                .pattern("LPL")
                .define('P', NC_PARTS.get("plate_advanced").get())
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("fission_reactor_glass").get())
                .pattern(" P ")
                .pattern("PTP")
                .pattern(" P ")
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("fission_reactor_solid_fuel_cell").get())
                .pattern("TGT")
                .pattern("G G")
                .pattern("TGT")
                .define('G', Tags.Items.GLASS)
        ...
        ShapedRecipeBuilder.shaped(HX_BLOCKS.get("heat_exchanger").get())
                .pattern("LPL")
                .pattern("PMP")
                .pattern("LPL")
                .define('M', NC_PARTS.get("chassis").get())
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("empty_heat_sink").get())
                .pattern("TIT")
                .pattern("ABA")
                .pattern("TIT")
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("empty_active_heat_sink").get())
                .pattern("TIT")
                .pattern("IBI")
                .pattern("TIT")
        ...
        for(String name: heatsinks.keySet()) {
            ...
            ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get(name+"_heat_sink").get())
                    .pattern(" I ")
                    .pattern("IBI")
                    .pattern(" I ")
                    .define('I', Ingredient.of(i))
    ...
    private void msrBlocks(Consumer<FinishedRecipe> consumer) {
        // MSR Controller
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("msr_controller").get())
                .pattern("LPL")
                .pattern("TDT")
                .pattern("LZL")
                .define('Z', CAULDRON)
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("msr_fuel_cell").get())
                .pattern("TGT")
                .pattern("GBG")
                .pattern("TGT")
                .define('G', Tags.Items.GLASS)
        ...
        ShapedRecipeBuilder.shaped(FISSION_BLOCKS.get("msr_port").get())
                .pattern("LPL")
                .pattern("MTM")
                .pattern("LPL")
                .define('M', NC_PARTS.get("servo").get())
    ...
    private void turbineBlocks(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(TURBINE_BLOCKS.get("turbine_basic_rotor_blade").get(), 2)
                .pattern(" P ")
                .pattern(" P ")
                .pattern(" P ")
        ...
        ShapedRecipeBuilder.shaped(TURBINE_BLOCKS.get("turbine_sic_sic_cmc_rotor_blade").get(), 2)
                .pattern(" P ")
                .pattern(" P ")
                .pattern(" P ")
    ...
    private void heatExchangerBlocks(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(HX_BLOCKS.get("heat_exchanger_casing").get(), 4)
                .pattern("SSS")
                .pattern("SLS")
                .pattern("SSS")
                .define('S', forgePlate(Materials.hsla_steel))
        ...
        ShapedRecipeBuilder.shaped(HX_BLOCKS.get("heat_exchanger_controller").get(), 1)
                .pattern("GCG")
                .pattern("CBC")
                .pattern("GCG")
        ...
        ShapedRecipeBuilder.shaped(HX_BLOCKS.get("heat_exchanger_radiator").get(), 2)
                .pattern("AAA")
                .pattern("AAA")
                .pattern("TTT")
        ...
        ShapedRecipeBuilder.shaped(HX_BLOCKS.get("heat_exchanger_hot_coolant_port").get(), 2)
                .pattern("TST")
                .pattern("SBS")
                .pattern("TST")
                .define('S', forgeIngot(Materials.hsla_steel))
        ...
        ShapedRecipeBuilder.shaped(HX_BLOCKS.get("heat_exchanger_cold_coolant_port").get(), 2)
                .pattern("TST")
                .pattern("SBS")
                .pattern("TST")
                .define('S', forgeIngot(Materials.hsla_steel))
    ...
    private void materials(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(NC_DUSTS.get(Materials.dimensional_blend).get(), 2)
                ...
                .save(consumer, MODID+"_"+Materials.dimensional_blend+"_dust");
        ...
        for(String name: Materials.ingots().keySet()) {
            if(Materials.ingots().get(name).block) {
                ShapelessRecipeBuilder.shapeless(NC_MATERIAL_BLOCKS.get(name).get())
    ...
    {
        ShapedRecipeBuilder.shaped(NCProcessors.PROCESSORS.get(Processors.SUBATOMIC_LIQUIFIER).get())
                .pattern("PYP")
                .pattern("PCP")
                .pattern("PMP")
        ...
        ShapedRecipeBuilder.shaped(RESONITE_CRYSTAL.get())
                .pattern("SSS")
                .pattern("SSS")
                .pattern("SSS")
