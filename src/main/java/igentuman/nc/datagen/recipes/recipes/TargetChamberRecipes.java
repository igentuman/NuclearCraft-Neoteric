...
public class TargetChamberRecipes extends AbstractRecipeProvider {
    ...
    public static void generate(Consumer<FinishedRecipe> consumer) {
        ...
        targetChamberItems(ingotIngredient("uranium"), particles(2000000, 0.1d, 100000, positron),
            List.of(particles(1000000, 0.05d, 50000, neutron)), ingotIngredient("thorium"), 50000000, 10, 0);

        // ===== Proton reactions =====
        targetChamberItems(isotopeIngredient(boron11), p(400, proton),
            List.of(po(3, alpha)), EMPTY, 900, 0.2, 8680);
        targetChamberItems(ingotIngredient("beryllium"), p(1000, proton),
            List.of(po(alpha)), isotopeIngredient(lithium6), 7500, 0.625, 2130);
        targetChamberItems(ingotIngredient("aluminum"), p(1500, proton),
            List.of(po(photon)), ingotIngredient("silicon"), 2000, 0.02, 11600);
        targetChamberFluids(List.of(fluidIngredient("tritium", 1000)), p(2400, proton),
            List.of(po(helion), po(neutron)), List.of(), 3600, 0.5, -764);
        targetChamberItems(isotopeIngredient(boron10), p(4000, proton),
            List.of(po(alpha)), isotopeIngredient(beryllium_7), 6000, 0.8, 1150);
        targetChamberFluids(List.of(fluidIngredient("fluorine", 1000)), p(4000, proton),
            List.of(po(alpha)), List.of(fluidIngredient("oxygen", 1000)), 11000, 0.5, 8110);
        targetChamberItems(ingotIngredient("copper"), p(4500, proton),
            List.of(po(photon)), ingotIngredient("zinc"), 5900, 0.04, 7710);
        targetChamberItems(ingotIngredient("cobalt"), p(4600, proton),
            List.of(po(photon)), ingotIngredient("nickel"), 5600, 0.2, 9530);
        targetChamberFluids(List.of(fluidIngredient("deuterium", 1000)), p(6000, proton),
            List.of(po(helion), po(photon)), List.of(), 10000, 0.02, 5490);
        targetChamberItems(ingotIngredient("osmium"), p(8300, proton),
            List.of(po(neutron)), isotopeIngredient(iridium_192), 10300, 0.16, -1830);
        targetChamberItems(ingotIngredient("manganese"), p(10000, proton),
            List.of(po(photon)), ingotIngredient("iron"), 19500, 0.02, 10200);
        targetChamberFluids(List.of(fluidIngredient("deuterium", 1000)), p(11000, proton),
            List.of(po(2, proton), po(neutron)), List.of(), 20500, 0.16, -2230);
        targetChamberItems(ingotIngredient("thorium"), p(11500, proton),
            List.of(po(2, neutron)), dustIngredient(protactinium_231), 16000, 0.625, -6830);
        targetChamberItems(isotopeIngredient(uranium238), p(12000, proton),
            List.of(po(2, neutron)), isotopeIngredient(neptunium237), 16500, 0.32, -6420);
        targetChamberMixed(ingotIngredient("gold"), null, p(12500, proton),
            List.of(po(2, neutron)), null, fluidIngredient("mercury", 144), 14000, 0.5, -8170);
        targetChamberItems(isotopeIngredient(plutonium242), p(12500, proton),
            List.of(po(2, neutron)), isotopeIngredient(americium241), 16500, 0.4, -7070);
        targetChamberItems(dustIngredient("bismuth"), p(14000, proton),
            List.of(po(photon)), dustIngredient("polonium"), 19000, 0.02, 4980);
        targetChamberItems(isotopeIngredient(boron11), p(15500, proton),
            List.of(po(photon)), dustIngredient("graphite"), 26000, 0.02, 16000);
        targetChamberItems(ingotIngredient("calcium"), p(16500, proton),
            List.of(po(2, proton)), ingotIngredient("potassium"), 25000, 1.0, -8330);
        targetChamberMixed(null, fluidIngredient("nitrogen", 1000), p(17000, proton),
            List.of(po(2, alpha)), isotopeIngredient(beryllium_7), null, 26000, 0.032, -10500);
        targetChamberMixed(null, fluidIngredient("oxygen", 1000), p(19000, proton),
            List.of(po(alpha), po(proton)), dustIngredient("graphite"), null, 25500, 0.25, -7160);
        targetChamberItems(ingotIngredient("silicon"), p(19000, proton),
            List.of(po(2, proton)), ingotIngredient("aluminum"), 28000, 1.0, -11600);
        targetChamberItems(isotopeIngredient(uranium238), p(19000, proton),
            List.of(po(3, neutron)), isotopeIngredient(neptunium236), 23000, 1.0, -13000);
        targetChamberItems(ingotIngredient("sodium"), p(20000, proton),
            List.of(po(proton), po(neutron)), isotopeIngredient(sodium_22), 28000, 0.5, -12400);
        targetChamberItems(dustIngredient("bismuth"), p(20000, proton),
            List.of(po(alpha)), ingotIngredient("lead"), 24000, 0.04, 10400);
        targetChamberItems(isotopeIngredient(uranium235), p(20500, proton),
            List.of(po(photon)), isotopeIngredient(neptunium236), 30000, 0.02, 4830);
        targetChamberItems(ingotIngredient("gold"), p(21000, proton),
            List.of(po(alpha)), ingotIngredient("platinum"), 25000, 0.064, 8490);
        targetChamberItems(isotopeIngredient(magnesium_26), p(23000, proton),
            List.of(po(alpha), po(neutron)), isotopeIngredient(sodium_22), 29000, 0.1, -14200);
        targetChamberItems(dustIngredient("graphite"), p(27000, proton),
            List.of(po(alpha), po(neutron), po(proton)), isotopeIngredient(beryllium_7), 35000, 0.08, -26300);
        targetChamberItems(isotopeIngredient(boron11), p(30000, proton),
            List.of(po(triton), po(2, neutron)), isotopeIngredient(beryllium_7), 33000, 0.05, -31400);
        targetChamberMixed(ingotIngredient("calcium"), null, p(30000, proton),
            List.of(po(3, proton)), null, fluidIngredient("argon", 1000), 43000, 0.20, -14700);
        targetChamberItems(ingotIngredient("silicon"), p(32000, proton),
            List.of(po(3, proton)), isotopeIngredient(magnesium_26), 50000, 0.2, -19900);
        targetChamberMixed(null, fluidIngredient("nitrogen", 1000), p(33000, proton),
            List.of(po(proton), po(deuteron)), dustIngredient("graphite"), null, 46000, 0.125, -10300);
        targetChamberItems(isotopeIngredient(magnesium_24), p(38000, proton),
            List.of(po(2, proton), po(neutron)), isotopeIngredient(sodium_22), 56000, 0.32, -24100);
        targetChamberItems(dustIngredient("graphite"), p(40000, proton),
            List.of(po(2, proton)), isotopeIngredient(boron11), 50000, 0.064, -16000);
        targetChamberFluids(List.of(fluidIngredient("oxygen", 1000)), p(40000, proton),
            List.of(po(proton), po(deuteron)), List.of(fluidIngredient("nitrogen", 1000)), 65000, 0.05, -20700);
        targetChamberItems(ingotIngredient("aluminum"), p(40000, proton),
            List.of(po(alpha), po(neutron), po(proton)), isotopeIngredient(sodium_22), 50000, 0.08, -22500);
        targetChamberItems(ingotIngredient("copper"), p(45000, proton),
            List.of(po(alpha)), ingotIngredient("nickel"), 56000, 0.625, 3760);
        targetChamberMixed(ingotIngredient("calcium"), null, p(51000, proton),
            List.of(po(helion), po(electron_neutrino), po(proton)), null, fluidIngredient("chlorine", 1000), 67000, 0.16, -18500);
        targetChamberItems(dustIngredient("graphite"), p(60000, proton),
            List.of(po(proton), po(deuteron)), isotopeIngredient(boron10), 85000, 0.08, -25200);
        targetChamberItems(dustIngredient("radium"), p(60000, proton),
            List.of(po(neutron)), waste("heavy"), 600000, 0.2, 0);
        targetChamberItems(ingotIngredient("thorium"), p(60000, proton),
            List.of(po(neutron)), waste("heavy"), 600000, 1.0, 0);
        ...
        targetChamberItems(isotopeIngredient(uranium234), p(60000, proton),
            List.of(po(2, neutron)), waste("heavy"), 600000, 1.0, 0);
        targetChamberItems(isotopeIngredient(uranium235), p(60000, proton),
            List.of(po(4, neutron)), waste("heavy"), 600000, 1.0, 0);
        ...
        for (Map.Entry<NcIngredient, NcIngredient> entry : spallationMaterials.entrySet()) {
            targetChamberItems(entry.getKey(), p(600000, proton),
                ...
                entry.getValue(), 5000000, 0.2, -279000);
        }
        targetChamberMixed(null, fluidIngredient("mercury", 144), p(600000, proton),
            List.of(po(pion_plus), po(pion_minus)), waste("mercury"), null, 5000000, 0.2, -279000);

        // Antiproton production via proton
        for (Map.Entry<NcIngredient, NcIngredient> entry : spallationMaterials.entrySet()) {
            targetChamberItems(entry.getKey(), p(5630000, proton),
                List.of(po(proton), po(antiproton)),
                entry.getValue(), 20000000, 0.2, -1880000);
        }
        targetChamberMixed(null, fluidIngredient("mercury", 144), p(5630000, proton),
            List.of(po(proton), po(antiproton)), waste("mercury"), null, 20000000, 0.2, -1880000);

        // ===== Neutron reactions =====
        targetChamberFluids(List.of(fluidIngredient("helium_3", 1000)), p(0, neutron),
            List.of(po(proton), po(triton)), List.of(), 18000, 0.1, 764);
        targetChamberItems(isotopeIngredient(beryllium_7), p(0, neutron),
            List.of(po(proton)), isotopeIngredient(lithium7), 10000, 1.0, 1640);
        targetChamberItems(isotopeIngredient(boron10), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(boron11), 1000, 0.02, 11500);
        targetChamberMixed(isotopeIngredient(sodium_22), null, p(0, neutron),
            List.of(po(proton)), null, fluidIngredient("neon", 1000), 11000, 0.25, 3630);
        targetChamberItems(ingotIngredient("cobalt"), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(cobalt_60), 10000, 0.5, 7490);
        targetChamberItems(isotopeIngredient(iridium_192), p(0, neutron),
            List.of(po(photon)), ingotIngredient("iridium"), 5000, 1.0, 7770);
        targetChamberItems(isotopeIngredient(uranium233), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(uranium234), 5000, 1.0, 6840);
        targetChamberItems(isotopeIngredient(uranium234), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(uranium235), 5000, 1.0, 5300);
        targetChamberItems(isotopeIngredient(neptunium236), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(neptunium237), 14000, 1.0, 6580);
        targetChamberItems(isotopeIngredient(plutonium238), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(plutonium239), 5000, 1.0, 5650);
        targetChamberItems(isotopeIngredient(plutonium241), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(plutonium242), 5000, 1.0, 6310);
        targetChamberItems(isotopeIngredient(americium241), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(americium242), 5000, 1.0, 5540);
        targetChamberItems(isotopeIngredient(americium242), p(0, neutron),
            List.of(po(photon)), isotopeIngredient(americium243), 5000, 1.0, 6370);
        targetChamberItems(dustIngredient("sulfur"), p(2800, neutron),
            List.of(po(alpha)), ingotIngredient("silicon"), 4000, 0.2, 1530);
        targetChamberItems(isotopeIngredient(lithium6), p(3000, neutron),
            List.of(po(alpha), po(neutron), po(deuteron)), EMPTY, 21000, 0.2, -1470);
        targetChamberMixed(null, fluidIngredient("chlorine", 1000), p(3000, neutron),
            List.of(po(alpha), po(electron_antineutrino), po(electron)), dustIngredient("sulfur"), null, 13500, 0.2, 2650);
        targetChamberMixed(ingotIngredient("calcium"), null, p(3000, neutron),
            List.of(po(alpha), po(electron_neutrino)), null, fluidIngredient("chlorine", 1000), 15500, 0.1, 2050);
        targetChamberItems(ingotIngredient("beryllium"), p(4000, neutron),
            List.of(po(2, alpha), po(2, neutron)), EMPTY, 14000, 0.5, -1570);
        targetChamberItems(isotopeIngredient(lithium7), p(5000, neutron),
            List.of(po(alpha), po(neutron), po(triton)), EMPTY, 17000, 0.25, -2470);
        targetChamberItems(ingotIngredient("zinc"), p(5500, neutron),
            List.of(po(alpha)), ingotIngredient("nickel"), 13000, 0.25, 3860);
        targetChamberMixed(null, fluidIngredient("nitrogen", 1000), p(6000, neutron),
            List.of(po(triton)), dustIngredient("graphite"), null, 16000, 0.02, -4010);
        targetChamberItems(isotopeIngredient(plutonium242), p(8500, neutron),
            List.of(po(2, neutron)), isotopeIngredient(plutonium241), 13000, 1.0, -6310);
        targetChamberItems(ingotIngredient("iridium"), p(9000, neutron),
            List.of(po(2, neutron)), isotopeIngredient(iridium_192), 19500, 1.0, -7770);
        targetChamberItems(isotopeIngredient(plutonium239), p(9000, neutron),
            List.of(po(2, neutron)), isotopeIngredient(plutonium238), 14000, 0.32, -5650);
        targetChamberItems(isotopeIngredient(americium243), p(9000, neutron),
            List.of(po(2, neutron)), isotopeIngredient(americium242), 14500, 1.0, -5540);
        targetChamberFluids(List.of(fluidIngredient("tritium", 1000)), p(10000, neutron),
            List.of(po(deuteron), po(2, neutron)), List.of(), 18000, 0.04, -6260);
        targetChamberItems(isotopeIngredient(neptunium237), p(10000, neutron),
            List.of(po(2, neutron)), isotopeIngredient(neptunium236), 14000, 1.0, -6580);
        targetChamberFluids(List.of(fluidIngredient("deuterium", 1000)), p(11000, neutron),
            List.of(po(proton), po(2, neutron)), List.of(), 54000, 0.16, -2230);
        targetChamberItems(ingotIngredient("iron"), p(11000, neutron),
            List.of(po(alpha)), ingotIngredient("chromium"), 22000, 0.1, 324);
        targetChamberItems(ingotIngredient("copper"), p(11000, neutron),
            List.of(po(proton), po(neutron)), ingotIngredient("nickel"), 15000, 1.0, -6120);
        targetChamberItems(ingotIngredient("chromium"), p(12000, neutron),
            List.of(po(alpha)), ingotIngredient("titanium"), 20000, 0.16, -1210);
        targetChamberItems(isotopeIngredient(boron11), p(12500, neutron),
            List.of(po(triton)), ingotIngredient("beryllium"), 20000, 0.04, -9560);
        targetChamberItems(ingotIngredient("aluminum"), p(13000, neutron),
            List.of(po(proton), po(neutron)), isotopeIngredient(magnesium_26), 30000, 0.8, -8270);
        targetChamberMixed(isotopeIngredient(magnesium_24), null, p(14000, neutron),
            List.of(po(alpha), po(neutron)), null, fluidIngredient("neon", 1000), 32000, 0.1, -9320);
        targetChamberItems(ingotIngredient("calcium"), p(14000, neutron),
            List.of(po(proton), po(neutron)), ingotIngredient("potassium"), 24000, 1.0, -8330);
        targetChamberItems(ingotIngredient("zinc"), p(14000, neutron),
            List.of(po(proton), po(neutron)), ingotIngredient("copper"), 24500, 1.0, -7710);
        targetChamberItems(ingotIngredient("beryllium"), p(15000, neutron),
            List.of(po(triton)), isotopeIngredient(lithium7), 26000, 0.064, -10400);
        targetChamberMixed(ingotIngredient("potassium"), null, p(15000, neutron),
            List.of(po(alpha), po(neutron)), null, fluidIngredient("chlorine", 1000), 32000, 0.1, -7220);
        targetChamberItems(ingotIngredient("zirconium"), p(15000, neutron),
            List.of(po(alpha)), ingotIngredient("strontium"), 20000, 0.04, 1760);
        targetChamberItems(isotopeIngredient(boron11), p(17000, neutron),
            List.of(po(2, neutron)), isotopeIngredient(boron10), 29000, 0.05, -11500);
        targetChamberItems(ingotIngredient("sodium"), p(17000, neutron),
            List.of(po(2, neutron)), isotopeIngredient(sodium_22), 28000, 0.25, -12400);
        targetChamberItems(isotopeIngredient(uranium235), p(17000, neutron),
            List.of(po(3, neutron)), isotopeIngredient(uranium233), 23500, 0.625, -12100);
        targetChamberItems(ingotIngredient("silicon"), p(18000, neutron),
            List.of(po(proton), po(neutron)), ingotIngredient("aluminum"), 27000, 0.8, -11600);
        targetChamberItems(dustIngredient("barium"), p(18200, neutron),
            List.of(po(proton)), dustIngredient(caesium_137), 34000, 0.016, -393);
        targetChamberItems(ingotIngredient("nickel"), p(19000, neutron),
            List.of(po(alpha), po(neutron)), ingotIngredient("iron"), 30000, 0.8, -6400);
        targetChamberItems(ingotIngredient("platinum"), p(19000, neutron),
            List.of(po(alpha)), ingotIngredient("osmium"), 27000, 0.025, 8730);
        targetChamberItems(dustIngredient("terbium"), p(20800, neutron),
            List.of(po(alpha), po(neutron)), dustIngredient(europium_155), 34000, 0.5, -140);
        targetChamberItems(ingotIngredient("zirconium"), p(21000, neutron),
            List.of(po(deuteron)), ingotIngredient("yttrium"), 36000, 0.625, -6130);
        targetChamberMixed(null, fluidIngredient("oxygen", 1000), p(22000, neutron),
            List.of(po(2, alpha)), ingotIngredient("beryllium"), null, 35000, 0.02, -12900);
        targetChamberItems(ingotIngredient("niobium"), p(22000, neutron),
            List.of(po(alpha), po(neutron)), ingotIngredient("yttrium"), 34000, 0.125, -1930);
        targetChamberItems(isotopeIngredient(uranium238), p(26000, neutron),
            List.of(po(4, neutron)), isotopeIngredient(uranium235), 34000, 0.55, -17800);
        targetChamberItems(ingotIngredient("manganese"), p(29000, neutron),
            List.of(po(triton)), ingotIngredient("chromium"), 46000, 0.625, -9300);
        targetChamberItems(dustIngredient("graphite"), p(29500, neutron),
            List.of(po(deuteron)), isotopeIngredient(boron11), 60000, 0.2, -13700);
        targetChamberItems(ingotIngredient("cobalt"), p(30000, neutron),
            List.of(po(triton)), ingotIngredient("iron"), 50000, 0.4, -8930);
        targetChamberItems(ingotIngredient("yttrium"), p(30000, neutron),
            List.of(po(deuteron)), ingotIngredient("strontium"), 49000, 0.32, -4840);
        targetChamberMixed(ingotIngredient("sodium"), null, p(30000, neutron),
            List.of(po(triton)), null, fluidIngredient("neon", 1000), 60000, 0.1, -10700);
        targetChamberItems(ingotIngredient("gold"), p(30000, neutron),
            List.of(po(alpha), po(neutron)), ingotIngredient("iridium"), 45000, 0.05, 967);
        targetChamberItems(isotopeIngredient(magnesium_24), p(35000, neutron),
            List.of(po(deuteron), po(neutron)), isotopeIngredient(sodium_22), 60000, 0.25, -21900);
        targetChamberFluids(List.of(fluidIngredient("helium", 1000)), p(40000, neutron),
            List.of(po(helion), po(2, neutron)), List.of(), 60000, 0.02, -20600);
        targetChamberItems(ingotIngredient("aluminum"), p(44000, neutron),
            List.of(po(helion), po(3, neutron)), isotopeIngredient(sodium_22), 80000, 0.05, -43100);
        targetChamberItems(isotopeIngredient(copernicium291), p(60000, neutron),
            List.of(po(8, neutron)), waste("heavy"), 1000000, 1.0, 0);
        targetChamberItems(dustIngredient("bismuth"), p(70000, neutron),
            List.of(po(triton)), ingotIngredient("lead"), 150000, 0.2, -2680);
        targetChamberItems(dustIngredient("graphite"), p(105000, neutron),
            List.of(po(helion), po(3, neutron)), isotopeIngredient(beryllium_7), 150000, 0.032, -46800);

        // ===== Photon reactions =====
        targetChamberFluids(List.of(fluidIngredient("deuterium", 1000)), p(2500, photon),
            List.of(po(proton), po(neutron)), List.of(), 14000, 0.02, -2230);
        targetChamberItems(isotopeIngredient(lithium6), p(5500, photon),
            List.of(po(alpha), po(neutron), po(proton)), EMPTY, 17000, 0.02, -3700);
        targetChamberFluids(List.of(fluidIngredient("helium_3", 1000)), p(9000, photon),
            List.of(po(2, proton), po(neutron)), List.of(), 36000, 0.02, -7720);
        targetChamberItems(isotopeIngredient(neptunium237), p(9750, photon),
            List.of(po(neutron)), isotopeIngredient(neptunium236), 14500, 1.0, -6580);
        targetChamberItems(isotopeIngredient(plutonium239), p(10000, photon),
            List.of(po(neutron)), isotopeIngredient(plutonium238), 13500, 0.4, -5650);
        targetChamberItems(isotopeIngredient(americium243), p(10000, photon),
            List.of(po(neutron)), isotopeIngredient(americium242), 12500, 1.0, -6360);
        targetChamberItems(ingotIngredient("tungsten"), p(11000, photon),
            List.of(po(alpha)), ingotIngredient("hafnium"), 16500, 0.25, 1660);
        targetChamberItems(ingotIngredient("zirconium"), p(11500, photon),
            List.of(po(proton)), ingotIngredient("yttrium"), 19000, 0.04, -8350);
        targetChamberItems(ingotIngredient("iridium"), p(12000, photon),
            List.of(po(neutron)), isotopeIngredient(iridium_192), 16000, 0.5, -7770);
        targetChamberItems(dustIngredient("bismuth"), p(12000, photon),
            List.of(po(proton), po(neutron)), ingotIngredient("lead"), 15000, 0.5, -11200);
        targetChamberItems(ingotIngredient("niobium"), p(13000, photon),
            List.of(po(alpha)), ingotIngredient("yttrium"), 21000, 0.02, -1930);
        targetChamberItems(isotopeIngredient(uranium235), p(13500, photon),
            List.of(po(2, neutron)), isotopeIngredient(uranium233), 18000, 0.32, -12100);
        targetChamberItems(ingotIngredient("iron"), p(14500, photon),
            List.of(po(proton)), ingotIngredient("manganese"), 21000, 0.125, -10200);
        targetChamberItems(ingotIngredient("yttrium"), p(16000, photon),
            List.of(po(proton)), ingotIngredient("strontium"), 23000, 0.016, -7070);
        targetChamberItems(ingotIngredient("aluminum"), p(17500, photon),
            List.of(po(proton)), isotopeIngredient(magnesium_26), 23000, 0.032, -8270);
        targetChamberItems(ingotIngredient("silicon"), p(18000, photon),
            List.of(po(proton)), ingotIngredient("aluminum"), 23000, 0.08, -11600);
        targetChamberItems(ingotIngredient("calcium"), p(18000, photon),
            List.of(po(proton)), ingotIngredient("potassium"), 22000, 0.05, -8330);
        targetChamberItems(isotopeIngredient(lithium6), p(18500, photon),
            List.of(po(helion), po(triton)), EMPTY, 25500, 0.02, -15800);
        targetChamberItems(isotopeIngredient(lithium7), p(18500, photon),
            List.of(po(neutron)), isotopeIngredient(lithium6), 24000, 0.02, -7250);
        targetChamberItems(ingotIngredient("copper"), p(19500, photon),
            List.of(po(proton), po(neutron)), ingotIngredient("nickel"), 27000, 0.05, -16700);
        targetChamberMixed(null, fluidIngredient("nitrogen", 1000), p(20000, photon),
            List.of(po(proton), po(neutron)), dustIngredient("graphite"), null, 27000, 0.02, -12500);
        targetChamberItems(isotopeIngredient(magnesium_26), p(21000, photon),
            List.of(po(2, neutron)), isotopeIngredient(magnesium_24), 28000, 0.04, -18400);
        targetChamberItems(isotopeIngredient(boron11), p(24500, photon),
            List.of(po(2, alpha), po(neutron), po(deuteron)), EMPTY, 30500, 0.02, -17400);
        targetChamberItems(ingotIngredient("beryllium"), p(26000, photon),
            List.of(po(2, alpha), po(neutron)), EMPTY, 46000, 0.02, -1570);
        targetChamberFluids(List.of(fluidIngredient("oxygen", 1000)), p(29000, photon),
            List.of(po(proton), po(neutron)), List.of(fluidIngredient("nitrogen", 1000)), 41000, 0.02, -23000);
        targetChamberItems(dustIngredient("graphite"), p(31500, photon),
            List.of(po(alpha), po(neutron)), isotopeIngredient(beryllium_7), 42500, 0.02, -26300);
        targetChamberItems(dustIngredient("graphite"), p(42500, photon),
            List.of(po(alpha), po(neutron), po(proton)), isotopeIngredient(lithium6), 55000, 0.02, -31900);

        // ===== Electron reactions =====
        targetChamberItems(ingotIngredient("iron"), p(50000, electron),
            List.of(po(alpha), po(electron)), ingotIngredient("chromium"), 100000, 0.01, -7610);
        targetChamberItems(ingotIngredient("cobalt"), p(50000, electron),
            List.of(po(alpha), po(electron)), ingotIngredient("manganese"), 100000, 0.01, -6940);
        targetChamberItems(ingotIngredient("zinc"), p(50000, electron),
            List.of(po(alpha), po(electron)), ingotIngredient("nickel"), 100000, 0.01, -3960);
        targetChamberItems(ingotIngredient("zirconium"), p(60000, electron),
            List.of(po(proton), po(electron)), ingotIngredient("yttrium"), 130000, 0.01, -8350);
        targetChamberItems(isotopeIngredient(uranium233), p(170000, electron),
            List.of(po(neutron), po(electron)), waste("heavy"), 300000, 0.01, 0);
        ...
        targetChamberFluids(List.of(fluidIngredient("tritium", 1000)), p(50, deuteron),
            List.of(po(alpha), po(neutron)), List.of(), 600, 0.5, 17100);
        targetChamberFluids(List.of(fluidIngredient("deuterium", 1000)), p(500, deuteron),
            List.of(po(triton), po(neutron)), List.of(), 3000, 0.16, 2740);
        targetChamberItems(isotopeIngredient(lithium6), p(500, deuteron),
            List.of(po(neutron)), isotopeIngredient(beryllium_7), 3000, 0.16, 3380);
        targetChamberItems(ingotIngredient("beryllium"), p(1500, deuteron),
            List.of(po(alpha)), isotopeIngredient(lithium7), 5000, 0.625, 7150);
        targetChamberItems(isotopeIngredient(boron11), p(1500, deuteron),
            List.of(po(neutron)), dustIngredient("graphite"), 3000, 0.5, 13700);
        targetChamberItems(isotopeIngredient(lithium7), p(3500, deuteron),
            List.of(po(2, alpha), po(neutron)), EMPTY, 9000, 1.0, 15100);
        targetChamberFluids(List.of(fluidIngredient("oxygen", 1000)), p(3500, deuteron),
            List.of(po(alpha)), List.of(fluidIngredient("nitrogen", 1000)), 10000, 0.25, 3110);
        targetChamberItems(dustIngredient("graphite"), p(5000, deuteron),
            List.of(po(alpha)), isotopeIngredient(boron10), 13000, 0.625, -1340);
        targetChamberItems(ingotIngredient("cobalt"), p(5000, deuteron),
            List.of(po(proton)), isotopeIngredient(cobalt_60), 10000, 0.4, 5270);
        targetChamberItems(isotopeIngredient(magnesium_24), p(6000, deuteron),
            List.of(po(alpha)), isotopeIngredient(sodium_22), 11000, 0.4, 1960);
        targetChamberItems(dustIngredient("bismuth"), p(10000, deuteron),
            List.of(po(neutron)), dustIngredient("polonium"), 15000, 0.08, 2760);
        targetChamberItems(isotopeIngredient(uranium233), p(10000, deuteron),
            List.of(po(proton)), isotopeIngredient(uranium234), 16000, 0.08, 4620);
        targetChamberItems(isotopeIngredient(plutonium241), p(10500, deuteron),
            List.of(po(2, neutron)), isotopeIngredient(americium241), 19500, 0.5, -2990);
        targetChamberItems(isotopeIngredient(uranium234), p(11000, deuteron),
            List.of(po(proton)), isotopeIngredient(uranium235), 17000, 0.32, 3070);
        targetChamberItems(isotopeIngredient(plutonium238), p(11000, deuteron),
            List.of(po(proton)), isotopeIngredient(plutonium239), 17000, 0.2, 3420);
        targetChamberItems(isotopeIngredient(uranium235), p(11500, deuteron),
            List.of(po(neutron)), isotopeIngredient(neptunium236), 19500, 0.032, 2610);
        targetChamberItems(ingotIngredient("osmium"), p(12000, deuteron),
            List.of(po(2, neutron)), isotopeIngredient(iridium_192), 14500, 1.0, -4050);
        targetChamberItems(isotopeIngredient(plutonium242), p(12000, deuteron),
            List.of(po(2, neutron)), isotopeIngredient(americium242), 16000, 0.5, -3760);
        targetChamberItems(isotopeIngredient(americium243), p(12000, deuteron),
            List.of(po(2, neutron)), isotopeIngredient(curium243), 15000, 0.2, -3010);
        targetChamberMixed(ingotIngredient("gold"), null, p(18000, deuteron),
            List.of(po(3, neutron)), null, fluidIngredient("mercury", 144), 24000, 0.5, -10400);
        targetChamberItems(isotopeIngredient(uranium238), p(24000, deuteron),
            List.of(po(4, neutron)), isotopeIngredient(neptunium236), 30000, 1.0, -15200);
        targetChamberItems(ingotIngredient("sodium"), p(30000, deuteron),
            List.of(po(deuteron), po(neutron)), isotopeIngredient(sodium_22), 55000, 0.4, -12400);
        targetChamberItems(ingotIngredient("beryllium"), p(34000, deuteron),
            List.of(po(deuteron), po(2, neutron)), isotopeIngredient(beryllium_7), 53000, 0.064, -20600);
        targetChamberItems(ingotIngredient("beryllium"), p(55000, deuteron),
            List.of(po(2, alpha), po(neutron), po(deuteron)), EMPTY, 150000, 1.0, -1570);
        targetChamberItems(ingotIngredient("aluminum"), p(56000, deuteron),
            List.of(po(alpha), po(triton)), isotopeIngredient(sodium_22), 200000, 0.08, -16300);
        targetChamberItems(ingotIngredient("yttrium"), p(60000, deuteron),
            List.of(po(alpha)), ingotIngredient("strontium"), 200000, 0.064, 7890);
        ...
        for (Map.Entry<NcIngredient, NcIngredient> entry : spallationMaterials.entrySet()) {
            targetChamberItems(entry.getKey(), p(11300000, deuteron),
                ...
                entry.getValue(), 20000000, 0.1, -3750000);
        }
        targetChamberMixed(null, fluidIngredient("mercury", 144), p(11300000, deuteron),
            List.of(po(deuteron), po(antideuteron)), waste("mercury"), null, 20000000, 0.1, -3750000);

        // ===== Triton reactions =====
        targetChamberItems(ingotIngredient("beryllium"), p(1000, triton),
            List.of(po(neutron)), isotopeIngredient(boron11), 7000, 1.0, 9560);
        targetChamberFluids(List.of(fluidIngredient("tritium", 1000)), p(1200, triton),
            List.of(po(alpha), po(2, neutron)), List.of(), 3000, 0.1, 10800);
        targetChamberItems(dustIngredient("graphite"), p(2500, triton),
            List.of(po(alpha)), isotopeIngredient(boron11), 7500, 0.625, 3860);
        targetChamberItems(isotopeIngredient(lithium6), p(8000, triton),
            List.of(po(2, neutron)), isotopeIngredient(beryllium_7), 12000, 0.064, -2520);

        // ===== Helion reactions =====
        targetChamberItems(isotopeIngredient(lithium6), p(11000, helion),
            List.of(po(deuteron)), isotopeIngredient(beryllium_7), 30000, 0.5, 113);
        targetChamberItems(ingotIngredient("cobalt"), p(14000, helion),
            List.of(po(2, proton)), isotopeIngredient(cobalt_60), 24000, 0.1, -226);
        targetChamberItems(dustIngredient("graphite"), p(22000, helion),
            List.of(po(2, alpha)), isotopeIngredient(beryllium_7), 31000, 0.125, -5690);
        targetChamberItems(ingotIngredient("beryllium"), p(23000, helion),
            List.of(po(alpha), po(neutron)), isotopeIngredient(beryllium_7), 28000, 0.16, 14);
        targetChamberItems(ingotIngredient("lead"), p(23000, helion),
            List.of(po(neutron)), dustIngredient("polonium"), 30000, 0.02, 1060);
        targetChamberItems(isotopeIngredient(neptunium237), p(23500, helion),
            List.of(po(proton), po(neutron)), isotopeIngredient(plutonium238), 30000, 0.02, -1720);
        targetChamberItems(isotopeIngredient(lithium6), p(30000, helion),
            List.of(po(2, alpha), po(proton)), EMPTY, 150000, 0.625, 16900);
        targetChamberItems(isotopeIngredient(boron10), p(30000, helion),
            List.of(po(alpha), po(neutron), po(proton)), isotopeIngredient(beryllium_7), 47000, 0.2, -6570);
        targetChamberItems(dustIngredient("bismuth"), p(30000, helion),
            List.of(po(proton), po(neutron)), dustIngredient("polonium"), 43000, 0.2, -2730);
        targetChamberItems(ingotIngredient("aluminum"), p(90000, helion),
            List.of(po(2, alpha)), isotopeIngredient(sodium_22), 165000, 0.16, -1930);

        // ===== Alpha reactions =====
        targetChamberItems(ingotIngredient("beryllium"), p(4000, alpha),
            List.of(po(neutron)), dustIngredient("graphite"), 6500, 1.0, 5700);
        targetChamberItems(isotopeIngredient(magnesium_26), p(4000, alpha),
            List.of(po(neutron)), ingotIngredient("silicon"), 6000, 0.32, 35);
        targetChamberItems(ingotIngredient("sodium"), p(4500, alpha),
            List.of(po(proton)), isotopeIngredient(magnesium_26), 6000, 0.16, 1820);
        targetChamberMixed(null, fluidIngredient("fluorine", 1000), p(6000, alpha),
            List.of(po(neutron)), isotopeIngredient(sodium_22), null, 11000, 0.25, -1950);
        targetChamberFluids(List.of(fluidIngredient("fluorine", 1000)), p(11000, alpha),
            List.of(po(proton)), List.of(fluidIngredient("neon", 1000)), 17500, 0.16, 1670);
        targetChamberItems(isotopeIngredient(lithium7), p(6500, alpha),
            List.of(po(neutron)), isotopeIngredient(boron10), 7600, 0.5, -2790);
        targetChamberItems(ingotIngredient("aluminum"), p(12000, alpha),
            List.of(po(positron), po(neutron), po(electron_neutrino)), ingotIngredient("silicon"), 17500, 0.4, 568);
        targetChamberFluids(List.of(fluidIngredient("nitrogen", 1000)), p(14000, alpha),
            List.of(po(proton), po(neutron)), List.of(fluidIngredient("oxygen", 1000)), 26000, 0.1, -5330);
        targetChamberItems(ingotIngredient("copper"), p(16000, alpha),
            List.of(po(proton)), ingotIngredient("zinc"), 20000, 0.16, -1540);
        targetChamberFluids(List.of(fluidIngredient("oxygen", 1000)), p(18000, alpha),
            List.of(po(positron), po(neutron), po(electron_neutrino)), List.of(fluidIngredient("fluorine", 1000)), 25000, 0.032, -9920);
        targetChamberItems(ingotIngredient("osmium"), p(19000, alpha),
            List.of(po(neutron)), ingotIngredient("platinum"), 27500, 0.025, -8730);
        targetChamberItems(isotopeIngredient(uranium235), p(21000, alpha),
            List.of(po(neutron)), isotopeIngredient(plutonium238), 32000, 0.02, -10900);
        targetChamberItems(dustIngredient("ytterbium"), p(21200, alpha),
            List.of(po(2, neutron)), ingotIngredient("hafnium"), 26600, 1.0, -14800);
        targetChamberItems(ingotIngredient("lead"), p(26000, alpha),
            List.of(po(2, neutron)), dustIngredient("polonium"), 32000, 1.0, -19500);
        targetChamberItems(isotopeIngredient(lithium6), p(27000, alpha),
            List.of(po(photon)), isotopeIngredient(boron10), 45000, 0.02, 4460);
        targetChamberItems(isotopeIngredient(uranium233), p(27000, alpha),
            List.of(po(proton)), isotopeIngredient(neptunium236), 30000, 0.02, -11300);
        targetChamberItems(isotopeIngredient(uranium238), p(27000, alpha),
            List.of(po(3, neutron)), isotopeIngredient(plutonium239), 30000, 0.625, -23100);
        targetChamberItems(isotopeIngredient(plutonium239), p(28000, alpha),
            List.of(po(proton)), isotopeIngredient(americium242), 30000, 0.02, -11700);
        targetChamberMixed(null, fluidIngredient("nitrogen", 1000), p(30000, alpha),
            List.of(po(alpha), po(neutron), po(proton)), dustIngredient("graphite"), null, 56000, 0.25, -12500);
        targetChamberItems(isotopeIngredient(uranium235), p(30000, alpha),
            List.of(po(triton)), isotopeIngredient(neptunium236), 35000, 0.016, -15500);
        targetChamberItems(isotopeIngredient(uranium238), p(34500, alpha),
            List.of(po(4, neutron)), isotopeIngredient(plutonium238), 42000, 0.128, -28700);
        targetChamberItems(dustIngredient("graphite"), p(38000, alpha),
            List.of(po(alpha), po(proton)), isotopeIngredient(boron11), 50000, 0.25, -16000);
        targetChamberItems(ingotIngredient("cobalt"), p(38000, alpha),
            List.of(po(2, proton), po(neutron)), isotopeIngredient(cobalt_60), 54000, 0.16, -20800);
        targetChamberItems(dustIngredient("graphite"), p(53000, alpha),
            List.of(po(alpha), po(neutron), po(proton)), isotopeIngredient(boron10), 69000, 0.16, -27400);
        targetChamberItems(ingotIngredient("beryllium"), p(100000, alpha),
            List.of(po(alpha), po(2, neutron)), isotopeIngredient(beryllium_7), 145000, 0.064, -20500);

        // ===== Boron Ion reactions =====
        targetChamberItems(ingredient(NC_PARTS.get("silicon_wafer").get()), particles(600, 2.0, 1, boron_ion),
            List.of(), ingredient(NC_PARTS.get("silicon_p_doped").get()), 1000, 1.0, 0);
        targetChamberItems(ingredient(FISSION_BLOCKS.get("fission_reactor_irradiation_chamber").get()), particles(1000, 3.0, 1, boron_ion),
            ...
            ingredient(FISSION_BLOCKS.get("fission_reactor_pile-driver_irradiation_chamber").get()), 2000, 0.25, 0);
        targetChamberItems(isotopeIngredient(lithium7), particles(6000, 1.0, 1, boron_ion),
            List.of(po(alpha), po(2, neutron)), dustIngredient("graphite"), 12000, 0.2, 5010);
        ...
        for (Map.Entry<NcIngredient, NcIngredient> entry : spallationMaterials.entrySet()) {
            targetChamberItems(entry.getKey(), p(1, antideuteron),
                ...
                entry.getValue(), 10000000, 1.0, 2090000);
        }
        targetChamberMixed(null, fluidIngredient("mercury", 144), p(1, antideuteron),
            List.of(po(4, pion_plus), po(4, pion_naught), po(4, pion_minus)),
            waste("mercury"), null, 10000000, 1.0, 2090000);
    }
    ...
    private static void targetChamberItems(NcIngredient inputItems, ParticleStack inputParticle, List<ParticleStack> outputParticles, NcIngredient outputItems, long maxEnergy, double crossSection, long energyReleased) {
        int recpieAmount = (int) (moleAmount / crossSection);
        inputParticle.setAmount(inputParticle.getAmount() * recpieAmount);
        targetChamber(List.of(), List.of(inputItems), List.of(inputParticle), outputParticles, List.of(), List.of(outputItems), maxEnergy, crossSection, energyReleased);
    }

    private static void targetChamberFluids(List<FluidStackIngredient> inputFluids, ParticleStack inputParticle, List<ParticleStack> outputParticles, List<FluidStackIngredient> outputFluids, long maxEnergy, double crossSection, long energyReleased) {
        int recpieAmount = (int) (moleAmount / crossSection);
        inputParticle.setAmount(inputParticle.getAmount() * recpieAmount);
        targetChamber(inputFluids, List.of(), List.of(inputParticle), outputParticles, outputFluids, List.of(), maxEnergy, crossSection, energyReleased);
    }

    private static void targetChamberMixed(NcIngredient inItem, FluidStackIngredient inFluid, ParticleStack inputParticle, List<ParticleStack> outputParticles, NcIngredient outItem, FluidStackIngredient outFluid, long maxEnergy, double crossSection, long energyReleased) {
        int recpieAmount = (int) (moleAmount / crossSection);
        inputParticle.setAmount(inputParticle.getAmount() * recpieAmount);
        targetChamber(
            ...
            maxEnergy, crossSection, energyReleased);
    }
}
