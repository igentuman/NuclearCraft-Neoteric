...
public enum AnomalyType {
    ...
    // Supplier keeps the registry-backed ParticleTypes constants out of enum static init, so the
    // placement algorithm and its unit tests can load this enum without bootstrapping Minecraft.
    ...
    /** Client-side only: the billboard sprite-sheet location. */
