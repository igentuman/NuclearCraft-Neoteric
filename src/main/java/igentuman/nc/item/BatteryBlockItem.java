...
public class BatteryBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (getBlock() instanceof AbstractStorageBlock block) {
            int capacity = StorageDefs.batteryStorage(block.storageName());
            tooltip.add(Component.translatable("tooltip.nuclearcraft.energy_capacity",
                    formatEnergy(capacity)).withStyle(ChatFormatting.BLUE));
        }
