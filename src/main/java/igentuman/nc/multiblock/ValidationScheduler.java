...
public class ValidationScheduler {
    ...
    public List<String> getSchedule() {
        // Step 1: Tarjan's algorithm to find strongly connected components (SCCs)
        ...
        // Step 2: Build SCC dependency graph for topological sort
        ...
        // Step 3: Topologically sort SCCs using Kahn's algorithm
        ...
        // Step 4: Create final schedule
        List<String> finalSchedule = new ArrayList<>();
        for (int idx: topoOrder) {
            List<String> scc = sccs.get(idx);
            if (isCyclic(scc)) {
                finalSchedule.addAll(scc); // Repeat cyclic SCCs once more for convergence
