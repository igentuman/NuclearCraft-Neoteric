 ...
 */
public abstract class AbstractInputRecipeCache<RECIPE extends NcRecipe> implements IInputRecipeCache {

    protected final NcRecipeType<RECIPE, ?> recipeType;
    protected boolean initialized;

    protected AbstractInputRecipeCache(NcRecipeType<RECIPE, ?> recipeType) {
