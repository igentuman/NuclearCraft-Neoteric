...
import igentuman.nc.util.math.FloatingLongConsumer;
import igentuman.nc.util.math.FloatingLongSupplier;
...
/**
 * Base class to help implement handling of Nuclearcraft recipes.
 */
@NothingNullByDefault
public abstract class CachedRecipe<RECIPE extends NcRecipe> {
     ...
     * #calculateOperationsThisTick(OperationTracker)} and to add any {@link OperationTracker.RecipeError}s that occur during post-processing.
     *
    ...
    /**
     * Sets the callback that run when the set of known {@link OperationTracker.RecipeError}s of this {@link CachedRecipe} changes.
     *
     * @param onErrorsChange Consumer to call with the set of {@link OperationTracker.RecipeError}s this {@link CachedRecipe} when they change.
     *
     ...
     * OperationTracker.RecipeError} using {@link OperationTracker#addError(OperationTracker.RecipeError)}.
     *
