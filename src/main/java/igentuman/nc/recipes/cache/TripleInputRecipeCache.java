...
public abstract class TripleInputRecipeCache<INPUT_A, INGREDIENT_A extends InputIngredient<INPUT_A>, INPUT_B, INGREDIENT_B extends InputIngredient<INPUT_B>,
      INPUT_C, INGREDIENT_C extends InputIngredient<INPUT_C>, RECIPE extends NcRecipe & TriPredicate<INPUT_A, INPUT_B, INPUT_C>,
    ...
    protected TripleInputRecipeCache(NcRecipeType<RECIPE, ?> recipeType, Function<RECIPE, INGREDIENT_A> inputAExtractor, CACHE_A cacheA,
