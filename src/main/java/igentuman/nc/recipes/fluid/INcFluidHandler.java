package igentuman.nc.recipes.fluid;
...
public interface INcFluidHandler extends ISidedFluidHandler, IContentsListener {

    /**
     * Used to check if an instance of {@link INcFluidHandler} actually has the ability to handle fluid.
     *
     * @return True if we are actually capable of handling fluid.
     *
     * @apiNote If for some reason you are comparing to {@link INcFluidHandler} without having gotten the object via the fluid handler capability, then you must
     * call this method to make sure that it really can handle fluid. As most nuclearcraft tiles have this class in their hierarchy.
     ...
     *
     * @return The list of all IExtendedFluidTanks that this {@link INcFluidHandler} contains for the given side. If there are no tanks for the side or {@link
