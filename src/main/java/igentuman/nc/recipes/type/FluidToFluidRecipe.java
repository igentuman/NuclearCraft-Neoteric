...
public abstract class FluidToFluidRecipe extends AbstractRecipe implements Predicate<@NotNull FluidStack> {
     ...
     * @return New output.
     *
     * @apiNote While Nuclearcraft does not currently make use of the input, it is important to support it and pass the proper value in case any addons define input based
