...
public interface INcInventory extends ISidedItemHandler, IContentsListener {

    /**
     * Used to check if an instance of {@link INcInventory} actually has an inventory.
     *
     * @return True if we are actually an inventory.
     *
     * @apiNote If for some reason you are comparing to {@link INcInventory} without having gotten the object via the item handler capability, then you must call
     * this method to make sure that it really is an inventory. As most nuclearcraft tiles have this class in their hierarchy.
     ...
     *
     * @return The list of all IInventorySlots that this {@link INcInventory} contains for the given side. If there are no slots for the side or {@link
