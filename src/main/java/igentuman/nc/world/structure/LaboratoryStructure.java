...
public class LaboratoryStructure extends Structure {

    public static final Codec<LaboratoryStructure> CODEC = RecordCodecBuilder.<LaboratoryStructure>mapCodec(instance ->
            ...
            ).apply(instance, LaboratoryStructure::new)).codec();
    ...
    public LaboratoryStructure(Structure.StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!LaboratoryStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return Registration.LABORATORY.get();
    }
}